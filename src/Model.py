...
class Model: 
	...
	def __init__(self, charList, decoderType=DecoderType.BestPath, mustRestore=False):
		...
		# input image batch
		# Eager Execution Example (TensorFlow 2.x) 
		self.inputImgs = tf.Variable(tf.random.normal([1, Model.imgSize[0], Model.imgSize[1]]), dtype=tf.float32)
        # For functions relying on placeholders, continue using tf.compat.v1 
